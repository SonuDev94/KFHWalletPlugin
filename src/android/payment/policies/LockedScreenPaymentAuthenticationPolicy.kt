...
class LockedScreenPaymentAuthenticationPolicy(private val screenLockVerifier: ScreenLockVerifier) :
    ...
    override fun getFinalAssessment(advice: WaAdvice): WaAssessment {
        return advice.assessment().also {
            AppLogger.d(TAG, "getFinalAssessment() $it")
        }
    }

    companion object {
        private val TAG = LockedScreenPaymentAuthenticationPolicy::class.java.simpleName
    }
}